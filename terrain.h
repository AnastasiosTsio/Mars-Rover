...
typedef enum { OK, ERREUR_FICHIER, CARACTER_INCONNUE, ERREUR_LIGNE_COURTE, ERREUR_LIGNE_LONGUE, ERREUR_LECTURE_LARGEUR, ERREUR_LIGNE_MANQUANTE, ERREUR_LECTURE_HAUTEUR, ERREUR_POSITION_ROBOT_MANQUANTE, ERREUR_HAUTEUR_INCORRECTE, ERREUR_LARGEUR_INCORRECTE} erreur_terrain;
